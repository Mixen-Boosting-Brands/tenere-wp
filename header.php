    ...
    <div class="menu">
     ...
     echo esc_url(home_url()); ?>#podcast<?php
      ...
      ?>#podcast<?php
                    ...
                    <li>
                        <a id="btn-nav-6" href="<?php echo esc_url(
                            get_page_link(7)
                        ); ?>">
                            Asesores
                        </a>
                ...
                <div class="col-6 col-lg-3 my-auto">
                    <a href="<?php echo esc_url(home_url()); ?>">
                        <img src="<?php echo esc_url(
                            get_template_directory_uri()
                        ); ?>/assets/images/logo.webp" alt="" class="logo img-fluid" id="logo-navbar">
                    </a>
                </div>
